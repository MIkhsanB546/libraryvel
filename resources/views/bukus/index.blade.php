                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-0 py-4">
                                    ...
                                    {{-- edit --}}
                                    {{-- edit btn --}}
                                    <button type="button" data-modal-target="edit-modal-{{ $buku->bukuID }}" data-modal-toggle="edit-modal-{{ $buku->bukuID }}"
                                    ...
                                    {{-- end edit btn --}}
                                    {{-- edit modal --}}
                                    <div id="edit-modal-{{ $buku->bukuID }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-modal-hide="edit-modal-{{ $buku->bukuID }}">
                                                ...
                                                @endif
                                                <form action="{{ route('bukus.update', ['bukuID' => $buku->bukuID]) }}" method="POST"
                                                    ...
                                                    <div class="">
                                                        <label for="tahun_terbit"
                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                            tahun_terbit</label>
                                                        <input type="number" id="tahun_terbit" name="tahun_terbit" value="{{ $buku->tahun_terbit }}"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            required>
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div class="flex items-center py-5 md:py-5">
                                                        <button data-modal-hide="edit-modal-{{ $buku->bukuID }}" type="submit"
                                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                            Submit</button>
                                                        <button data-modal-hide="edit-modal-{{ $buku->bukuID }}" type="button"
                                    ...
                                    {{-- delete --}}
                                    <form action="{{ route('bukus.destroy', ['bukuID' => $buku->bukuID]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
